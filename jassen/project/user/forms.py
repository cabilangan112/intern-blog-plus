...
class RegisterForm(forms.ModelForm):
	...
	class Meta:
		model = MyUser
		fields = ('cover_photo','profile_picture','email','first_name','last_name','MI','Sex','date_of_birth','Age')

	def clean_last_name(self):
		last_name = self.cleaned_data.get("last_name")
		qs = MyUser.objects.filter(first_name__iexact=last_name)
		if qs.exists():
	...
	def clean_first_name(self):
		...
		qs = MyUser.objects.filter(first_name__iexact=first_name)
		if qs.exists():
